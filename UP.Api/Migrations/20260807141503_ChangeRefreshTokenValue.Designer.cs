...
namespace UP.Api.Migrations
{
    ...
    [Migration("20260807141503_ChangeRefreshTokenValue")]
    partial class ChangeRefreshTokenValue
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UP.Api.Features.AuthFeature.AuthUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("UP.Api.Features.AuthFeature.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("UP.Api.Features.AuthFeature.AuthUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("UP.Api.Features.AuthFeature.RefreshToken", b =>
                {
                    b.HasOne("UP.Api.Features.AuthFeature.AuthUser", "AuthUser")
