...
namespace UP.Api.Migrations
{
    ...
    [Migration("20260925102214_init_v6")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UP.Api.Features.AppUserFeature.Models.AppUser.AppUserModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("UP.Api.Features.AuthFeature.Models.AuthUser.AuthUserModel", null)
                        .WithMany()
            ...
            modelBuilder.Entity("UP.Api.Features.AppUserFeature.Models.AppUser.AppUserModel", b =>
                {
                    b.HasOne("UP.Api.Features.AuthFeature.Models.AuthUser.AuthUserModel", "AuthUser")
                        .WithOne()
                        .HasForeignKey("UP.Api.Features.AppUserFeature.Models.AppUser.AppUserModel", "AuthUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("UP.Api.Features.AuthFeature.Models.RefreshToken.RefreshTokenModel", b =>
                {
                    ...
                    b.HasOne("UP.Api.Features.AuthFeature.Models.RefreshToken.RefreshTokenModel", "ReplacedByToken")
                        .WithMany()
